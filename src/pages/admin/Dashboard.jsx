  ...
  return (
    <AdminLayout>
      {isLoading ? (
        ...
        <div className="w-full flex flex-col sm:p-[1rem]">
          <div className="flex flex-col">
            ...
            <div className="w-full h-[20rem] mt-5 flex flex-col rounded-md p-4 justify-center items-center shadow shadow-gray-400 relative">
              <DoughnutChart
                data={[rows.singleChatCount, rows.groupChatCount]}
...
const Widget = ({ title, value, icon: Icon }) => {
  return (
    <div className="flex flex-col items-center justify-center p-[1rem] sm:p-[2rem] space-y-2 shadow shadow-gray-400 rounded-lg">
      <p className="flex flex-col items-center justify-center rounded-full border-4 border-[#590959] w-[4rem] h-[4rem]">
        {value}
      </p>
